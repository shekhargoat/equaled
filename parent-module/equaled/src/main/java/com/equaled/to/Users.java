...
public class Users extends BaseEntity {
    ...
    public boolean equals(Object o) {
        ...
        return id == users.id && enabled == users.enabled && relatedAccount == users.relatedAccount
                ...
                && Objects.equals(lastUpdatedOn, users.lastUpdatedOn) && Objects.equals(yearGroupId, users.yearGroupId);
    }

    @Override
    public int hashCode() {
        int result = Objects.hash(id, username, password, email, role, enabled, lastLogin, lastUpdatedOn, relatedAccount, yearGroupId);
