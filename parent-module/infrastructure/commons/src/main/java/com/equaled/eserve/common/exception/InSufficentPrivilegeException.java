...
public class InSufficentPrivilegeException extends BaseException{

	private static final long serialVersionUID = -408992320053047142L;
	
	public InSufficentPrivilegeException(Throwable e) {
		super(e);
	}

	public InSufficentPrivilegeException(ErrorCodes errorCoEnum) {
		this.errorCode = errorCoEnum;
	}

	public InSufficentPrivilegeException(ErrorCodes errorCoEnum, String devMsg) {
		this.errorCode = errorCoEnum;
		this.devMessage = devMsg;
	}
	public InSufficentPrivilegeException(Throwable e,ErrorCodes error) {
		this.e=e;
