...
public class DatabaseException extends BaseException {
	...
	private static final long serialVersionUID = 9031782032124455630L;

	public DatabaseException(Throwable e) {
		super(e);
	}

	public DatabaseException(ErrorCodes errorCoEnum) {
		this.errorCode = errorCoEnum;
	}

	public DatabaseException(ErrorCodes errorCoEnum, String devMsg) {
		this.errorCode = errorCoEnum;
		this.devMessage = devMsg;
	}
	public DatabaseException(Throwable e,ErrorCodes error) {
		this.e=e;
