...
public class InvalidTokenException extends BaseException {
	...
	private static final long serialVersionUID = -9043851459485028118L;

	public InvalidTokenException(Throwable e) {
		super(e);
	}

	public InvalidTokenException(ErrorCodes errorCoEnum) {
		this.errorCode = errorCoEnum;
	}

	public InvalidTokenException(ErrorCodes errorCoEnum, String devMsg) {
		this.errorCode = errorCoEnum;
		this.devMessage = devMsg;
	}
	public InvalidTokenException(Throwable e,ErrorCodes error) {
		this.e=e;
